...
BRIDGE_HOST = "100.93.202.151"
BRIDGE_USER = "ameliahedtkealiceelliott"
BRIDGE_COMMAND = "Bridge"  # Optional if used
...
def init_ssh():
    ...
    try:
        ...
        ssh_client.connect(BRIDGE_HOST, username=BRIDGE_USER)
...
def start_timers():
    ...
    schedule_prompt(3600, "Should I backup? Only say DO_BACKUP_NOW or NO_BACKUP_NEEDED")             # Every 1 hour
...
def ai_backup():
    try:
        ...
        new_filename = f"dontRunAIBridge_{timestamp}.py"
